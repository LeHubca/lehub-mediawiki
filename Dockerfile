...
RUN curl -O https://extdist.wmflabs.org/dist/extensions/VisualEditor-REL1_36-c9fc510.tar.gz && \
  tar -xzf VisualEditor-REL1_36-c9fc510.tar.gz -C /var/www/html/extensions && \
  rm VisualEditor-REL1_36-c9fc510.tar.gz && \
